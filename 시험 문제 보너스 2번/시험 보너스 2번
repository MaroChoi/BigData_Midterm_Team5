...
def some_function(input_file):
    ...
    ordinal_numeric_cols = ['cp', 'restecg', 'slope', 'ca', 'thal']
    nominal_numeric_cols = ['sex', 'fbs', 'exang']
    ordinal_string_cols = []
    nominal_string_cols = []
    ...
    # 파생변수 생성 (목적: 심장질환 조기 예측에 도움되는 변수)
    # 예시: 혈압 대비 콜레스테롤 비율 (trestbps/chol)
    ...
    # 새로 만든 파생변수 추가
    numerical_cols_selected.append('BP_CHOL_RATIO')
...
df = pd.read_csv('/Users/imsu-in/Downloads/myproject/midtermtest/BigData_Midterm_Team5/BigData_Midterm_Team5-8/7_heart.csv')
...
# 최종 값
input_file = '/Users/imsu-in/Downloads/myproject/midtermtest/BigData_Midterm_Team5/BigData_Midterm_Team5-8/7_heart.csv'
